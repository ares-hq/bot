    ...
    async def match(self, interaction: discord.Interaction, red_alliance: str, blue_alliance: str = None):
        ...
        try:
            ...
            if winner == "Tie" or not blue_alliance_teams:
                ...
                winningTeam = match.redAlliance.teamNames
            elif winner == "Blue":
                color = State.FIRST_BLUE
                winningTeam = match.blueAlliance.teamNames
            ...
            if blue_alliance_teams:  # If blue alliance is provided, make full match embed
                ...
                if winner != "Tie":
                    winner_team_1 = trim_string(f"{winningTeam[0]} ({blue_alliance_teams[0]})")
                    winner_team_2 = trim_string(f"{winningTeam[1]} ({blue_alliance_teams[1]})")
